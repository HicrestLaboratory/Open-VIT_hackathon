...
if (len(sys.argv) == 3):
    ...
    if tot_batches != 0:
        ...
        out_file.write('   Average model load time: N/A (no batches processed)\n')
        out_file.write('   Average batch load time: N/A (no batches processed)\n')
        out_file.write('   Average foreward time per batch: N/A (no batches processed)\n')
        out_file.write('      Patch Embed: N/A (no batches processed)\n')
        out_file.write('      Position Embed: N/A (no batches processed)\n')
        out_file.write('      Attention: N/A (no batches processed)\n')
        out_file.write('      MLP: N/A (no batches processed)\n')
        out_file.write('      Pool: N/A (no batches processed)\n')
        out_file.write('      Head: N/A (no batches processed)\n')
        out_file.write('   Average store time per prediction batch: N/A (no batches processed)\n')
    ...
    if tot_pictures != 0:
        ...
        out_file.write('   Average picture load time: N/A (no pictures processed)\n')
        out_file.write('   Average foreward time per picture: N/A (no pictures processed)\n')
        out_file.write('      Patch Embed: N/A (no pictures processed)\n')
        out_file.write('      Position Embed: N/A (no pictures processed)\n')
        out_file.write('      Attention: N/A (no pictures processed)\n')
        out_file.write('      MLP: N/A (no pictures processed)\n')
        out_file.write('      Pool: N/A (no pictures processed)\n')
        out_file.write('      Head: N/A (no pictures processed)\n')
        out_file.write('   Average store time per single prediction : N/A (no pictures processed)\n')
